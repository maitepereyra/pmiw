class enemigo {
  ...
  atacar() {
    if (this.contadorDisparos >= this.tiempoEntreDisparos && this.juego && programaPrincipal.juego.personaje && programaPrincipal.juego.personaje.vida) {
      this.proyectil = new proyectil(this.posX, this.posY, this.juego.personaje.posX, this.juego.personaje.posY);
      this.proyectil.usar();
